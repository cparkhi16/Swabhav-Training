...
void do_something_with_dog_v1( Dog *d){
	d->set_dog_name("heeee");
	std::cout <<"Within do v1 ";
    d->print_info() ;
}
...
int main(){
	...
	//do_something_with_dog_v1(p_dog_1.get());
    /*
...
//---------------------------------------------------------------------------
	...
	//p_dog_2->print_info();
	do_something_with_dog_v2(std::make_unique<Dog>("Dog2"));
	std::cout << "-----" << std::endl;
	//p_dog_2->print_info();
